...
class StoreControllerTest {
    ...
    void 매장리스트조회_카테고리() throws Exception {
        //given
        doReturn(매장리스트조회요청_생성_카테고리()).when(storeService)
                .getStoreListByCategory(1L, 1, 10);
        ...
        var response = new Gson().fromJson(mvcResult.getResponse().getContentAsString(), List.class);
    ...
    void 매장리스트조회_카테고리_주소() throws Exception {
        ...
        doReturn(매장리스트조회요청_생성_카테고리_주소()).when(storeService)
